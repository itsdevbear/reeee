...
contract ERC4626Test is DSTestPlus {
    ...
    function setUp() public {
        ...
        wethVault = IERC4626(
            address(new MockERC4626(weth, "Mock ERC4626", "mTKN"))
        );
    ...
    function testDepositWithPermitViaMulticall(uint256 amount) public {
        ...
        data[2] = abi.encodeWithSelector(
            IERC4626Router.depositToVault.selector,
            vault,
            owner,
            amount,
            amount
    ...
    function testWithdrawWithPermitViaMulticall(uint128 amount) public {
        ...
        data[1] = abi.encodeWithSelector(
            IERC4626RouterBase.withdraw.selector,
            vault,
            owner,
            amount,
            amount
    ...
    function testRedeemWithPermitViaMulticall(uint128 amount) public {
        ...
        data[1] = abi.encodeWithSelector(
            IERC4626RouterBase.redeem.selector,
            vault,
            owner,
            amount,
            amount
    ...
    function testDepositETHToWETHVault(uint256 amount) public {
        ...
        data[1] = abi.encodeWithSelector(
            ERC4626RouterBase.deposit.selector,
            wethVault,
            address(this),
            amount,
            amount
