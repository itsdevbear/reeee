...
// 	Ctx        sdk.Context
// 	Commission bongatypes.CommissionRates
// 	// Coin Denomination
// 	Denom string
// }
...
// func (sh *Helper) CreateValidatorMsg(addr sdk.ValAddress, pk cryptotypes.PubKey, stakeAmount sdk.Int) *bongatypes.MsgCreateValidator {
// 	coin := sdk.NewCoin(sh.Denom, stakeAmount)
// 	msg, err := bongatypes.NewMsgCreateValidator(addr, pk, coin, bongatypes.Description{}, sh.Commission, sdk.OneInt())
...
// 	coin := sdk.NewCoin(sh.Denom, amount)
// 	msg := bongatypes.NewMsgDelegate(delegator, val, coin)
// 	sh.Handle(msg, true)
// }
...
// 	msg := bongatypes.NewMsgUndelegate(delegator, val, unbondAmt)
...
// func (sh *Helper) CheckValidator(addr sdk.ValAddress, status bongatypes.BondStatus, jailed bool) bongatypes.Validator {
...
// func ZeroCommission() bongatypes.CommissionRates {
// 	return bongatypes.NewCommissionRates(sdk.ZeroDec(), sdk.ZeroDec(), sdk.ZeroDec())
// }
