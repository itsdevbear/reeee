...
```bash
bera.bonga.v1beta1.Query/Validators
```

Example:

```bash
grpcurl -plaintext localhost:9090 bera.bonga.v1beta1.Query/Validators
```
...
```bash
bera.bonga.v1beta1.Query/Validator
```
...
localhost:9090 bera.bonga.v1beta1.Query/Validator
```
...
```bash
bera.bonga.v1beta1.Query/ValidatorDelegations
```
...
```bash
grpcurl -plaintext -d '{"validator_addr":"cosmosvaloper1rne8lgs98p0jqe82sgt0qr4rdn4hgvmgp9ggcc"}' \
localhost:9090 bera.bonga.v1beta1.Query/ValidatorDelegations
```
...
```bash
bera.bonga.v1beta1.Query/ValidatorUnbondingDelegations
```
...
```bash
grpcurl -plaintext -d '{"validator_addr":"cosmosvaloper1rne8lgs98p0jqe82sgt0qr4rdn4hgvmgp9ggcc"}' \
localhost:9090 bera.bonga.v1beta1.Query/ValidatorUnbondingDelegations
```
...
```bash
bera.bonga.v1beta1.Query/Delegation
```
...
localhost:9090 bera.bonga.v1beta1.Query/Delegation
```
...
```bash
bera.bonga.v1beta1.Query/UnbondingDelegation
```
...
grpcurl -plaintext \
-d '{"delegator_addr": "cosmos1y8nyfvmqh50p6ldpzljk3yrglppdv3t8phju77", validator_addr":"cosmosvaloper1rne8lgs98p0jqe82sgt0qr4rdn4hgvmgp9ggcc"}' \
localhost:9090 bera.bonga.v1beta1.Query/UnbondingDelegation
```
...
```bash
bera.bonga.v1beta1.Query/DelegatorDelegations
```
...
localhost:9090 bera.bonga.v1beta1.Query/DelegatorDelegations
```
...
```bash
bera.bonga.v1beta1.Query/DelegatorUnbondingDelegations
```
...
grpcurl -plaintext \
-d '{"delegator_addr": "cosmos1y8nyfvmqh50p6ldpzljk3yrglppdv3t8phju77"}' \
localhost:9090 bera.bonga.v1beta1.Query/DelegatorUnbondingDelegations
```
...
```bash
bera.bonga.v1beta1.Query/Redelegations
```
...
localhost:9090 bera.bonga.v1beta1.Query/Redelegations
```
...
```bash
bera.bonga.v1beta1.Query/DelegatorValidators
```
...
localhost:9090 bera.bonga.v1beta1.Query/DelegatorValidators
```
...
```bash
bera.bonga.v1beta1.Query/DelegatorValidator
```
...
localhost:9090 bera.bonga.v1beta1.Query/DelegatorValidator
```
...
```bash
bera.bonga.v1beta1.Query/HistoricalInfo
```

Example:

```bash
grpcurl -plaintext -d '{"height" : 1}' localhost:9090 bera.bonga.v1beta1.Query/HistoricalInfo
```
...
```bash
bera.bonga.v1beta1.Query/Pool
```

Example:

```bash
grpcurl -plaintext -d localhost:9090 bera.bonga.v1beta1.Query/Pool
```
...
```bash
bera.bonga.v1beta1.Query/Params
```

Example:

```bash
grpcurl -plaintext localhost:9090 bera.bonga.v1beta1.Query/Params
```
...
```bash
/bera/bongav1beta1/delegations/{delegatorAddr}
```

Example:

```bash
curl -X GET "http://localhost:1317/bera/bongav1beta1/delegations/cosmos1vcs68xf2tnqes5tg0khr0vyevm40ff6zdxatp5" -H  "accept: application/json"
```
...
```bash
/bera/bongav1beta1/delegators/{delegatorAddr}/redelegations
```
...
```bash
curl -X GET \
"http://localhost:1317/bera/bongav1beta1/delegators/cosmos1thfntksw0d35n2tkr0k8v54fr8wxtxwxl2c56e/redelegations?srcValidatorAddr=cosmosvaloper1lzhlnpahvznwfv4jmay2tgaha5kmz5qx4cuznf&dstValidatorAddr=cosmosvaloper1vq8tw77kp8lvxq9u3c8eeln9zymn68rng8pgt4" \
...
```bash
/bera/bongav1beta1/delegators/{delegatorAddr}/unbonding_delegations
```
...
```bash
curl -X GET \
"http://localhost:1317/bera/bongav1beta1/delegators/cosmos1nxv42u3lv642q0fuzu2qmrku27zgut3n3z7lll/unbonding_delegations" \
-H  "accept: application/json"
```
...
```bash
/bera/bongav1beta1/delegators/{delegatorAddr}/validators
```
...
```bash
curl -X GET \
"http://localhost:1317/bera/bongav1beta1/delegators/cosmos1xwazl8ftks4gn00y5x3c47auquc62ssune9ppv/validators" \
-H  "accept: application/json"
```
...
```bash
/bera/bongav1beta1/delegators/{delegatorAddr}/validators/{validatorAddr}
```
...
```bash
curl -X GET \
"http://localhost:1317/bera/bongav1beta1/delegators/cosmos1xwazl8ftks4gn00y5x3c47auquc62ssune9ppv/validators/cosmosvaloper1xwazl8ftks4gn00y5x3c47auquc62ssuvynw64" \
-H  "accept: application/json"
```
...
```bash
/bera/bongav1beta1/historical_info/{height}
```

Example:

```bash
curl -X GET "http://localhost:1317/bera/bongav1beta1/historical_info/153332" -H  "accept: application/json"
```
...
```bash
/bera/bongav1beta1/params
```

Example:

```bash
curl -X GET "http://localhost:1317/bera/bongav1beta1/params" -H  "accept: application/json"
```
...
```bash
/bera/bongav1beta1/pool
```

Example:

```bash
curl -X GET "http://localhost:1317/bera/bongav1beta1/pool" -H  "accept: application/json"
```
...
```bash
/bera/bongav1beta1/validators
```

Example:

```bash
curl -X GET "http://localhost:1317/bera/bongav1beta1/validators" -H  "accept: application/json"
```
...
```bash
/bera/bongav1beta1/validators/{validatorAddr}
```
...
```bash
curl -X GET \
"http://localhost:1317/bera/bongav1beta1/validators/cosmosvaloper16msryt3fqlxtvsy8u5ay7wv2p8mglfg9g70e3q" \
-H  "accept: application/json"
```
...
```bash
/bera/bongav1beta1/validators/{validatorAddr}/delegations
```

Example:

```bash
curl -X GET "http://localhost:1317/bera/bongav1beta1/validators/cosmosvaloper16msryt3fqlxtvsy8u5ay7wv2p8mglfg9g70e3q/delegations" -H  "accept: application/json"
```
...
```bash
/bera/bongav1beta1/validators/{validatorAddr}/delegations/{delegatorAddr}
```
...
```bash
curl -X GET \
"http://localhost:1317/bera/bongav1beta1/validators/cosmosvaloper16msryt3fqlxtvsy8u5ay7wv2p8mglfg9g70e3q/delegations/cosmos1n8f5fknsv2yt7a8u6nrx30zqy7lu9jfm0t5lq8" \
-H  "accept: application/json"
```
...
```bash
/bera/bongav1beta1/validators/{validatorAddr}/delegations/{delegatorAddr}/unbonding_delegation
```
...
```bash
curl -X GET \
"http://localhost:1317/bera/bongav1beta1/validators/cosmosvaloper13v4spsah85ps4vtrw07vzea37gq5la5gktlkeu/delegations/cosmos1ze2ye5u5k3qdlexvt2e0nn0508p04094ya0qpm/unbonding_delegation" \
-H  "accept: application/json"
```
...
```bash
/bera/bongav1beta1/validators/{validatorAddr}/unbonding_delegations
```
...
```bash
curl -X GET \
"http://localhost:1317/bera/bongav1beta1/validators/cosmosvaloper13v4spsah85ps4vtrw07vzea37gq5la5gktlkeu/unbonding_delegations" \
-H  "accept: application/json"
```
