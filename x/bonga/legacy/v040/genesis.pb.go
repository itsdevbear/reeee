...
func init() {
	// proto.RegisterType((*GenesisState)(nil), "bera.bonga.v1beta1.GenesisState")
	// proto.RegisterType((*LastValidatorPower)(nil), "bera.bonga.v1beta1.LastValidatorPower")
}

func init() {
	// proto.RegisterFile("bera/bongav1beta1/genesis.proto", fileDescriptor_9b3dec8894f2831b)
}
