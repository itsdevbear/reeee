...
func TestPrepareConfigForTxCreateValidator(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			fsModify: func(fs *pflag.FlagSet) {
				fs.Set(FlagMinSelfDelegation, "0.33") //nolint
			},
